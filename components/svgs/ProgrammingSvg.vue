<template>
  <svg
    ...
    data-name="Layer 1"
    width="1041.3199462890625"
    height="554.1699829101562"
    viewBox="0 0 1041.32 554.17"
    class="w-full h-auto mb-10 sm:mb-0"
  >
    <defs>
      <linearGradient
        id="dff037aa-d578-4bab-81e7-399360663117-75"
        x1="597.75"
        y1="725.44"
        x2="597.75"
        y2="347.69"
    ...
    <path
      ...
      transform="translate(-79.34 -172.91)"
      fill="url(#dff037aa-d578-4bab-81e7-399360663117-75)"
      class="svg-elem-42"
    ></path>
    <path
...
line {
  ...
  @for $i from 1 through 6 {
    &:nth-of-type(#{$i}) {
      animation-timing-function: steps(#{8 - $i}, end);
    }
  }
}
@keyframes dash {
